...
class Repairs(models.Model):
    rBrand = models.CharField('Бренд', max_length=50)
    rModel = models.CharField('Модель', max_length=50)
    cause = models.CharField('Причина', max_length=200)
    rDate = models.DateField('Дата поступления')
